...
"""# The main settings for platform_service_example.
...
5. Overrides from standard paths.
   - /etc/ansible-automation-platform/platform_service_example/
6. Overrides from environment variables prefixed with PLATFORM_SERVICE_EXAMPLE_.
...
> or set environment variables prefixed with `PLATFORM_SERVICE_EXAMPLE_`.
...
TEMPLATES = [
    {
        ...
        "DIRS": ["apps/core/templates", "apps/api/templates"],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
app_prefix = "PLATFORM_SERVICE_EXAMPLE"
