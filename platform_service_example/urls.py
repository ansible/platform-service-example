...
"""
URL configuration for platform_service_example.
...
urlpatterns += [
    path("v1/", APIRootView.as_view(view_name="v1"), name="v1-index"),
    path("", APIRootView.as_view(view_name="platform_service_example"), name="index"),
]
